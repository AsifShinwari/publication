    ...
    <div class="container">
        <div class="row mt-2">
            <div class="col-12 alert-secondary">
                <h5 class="text-center">Add New Publication
                    <!-- loading Status -->
                    <div wire:loading>
        ...
        <div class="row">
            ...
            <div class="col-3 pt-2">
                <label for="image" class="mb-0">Book Image</label>
                <input type="file" name="image" wire:model="image" class="form-control">
                @error('image') <span class="text-danger">{{$message}}</span> @enderror
            </div>
            <div class="col-3 pt-2">
                <label for="book_pdf" class="mb-0">Book PDF</label>
            ...
            <div class="col-3 pt-2">
                <label for="table_of_content_pdf" class="mb-0">Book Table Of Contents PDF</label>
