    ...
    <div class="container">
        <div class="row mt-2">
            <div class="col-12 alert-secondary">
                <h5 class="text-center">Update Archive Info
                    <!-- loading Status -->
                    <div wire:loading>
        ...
        <input type="hidden" name="journal_id" value="{{$data->journal_id}}">
        <div class="row">
            <div class="col-6 pt-2">
                <label for="volume" class="mb-0">Volume</label>
                <input type="text" name="volume" value="{{$data->volume}}" class="form-control"
            ...
            <div class="col-6 pt-2">
                ...
                <input type="date" name="year" value="{{$data->year}}" class="form-control"
                placeholder="Enter Year">
                @error('year') <span class="text-danger">{{$message}}</span> @enderror
            </div>
            <div class="col-6 pt-2">
                <label for="issue" class="mb-0">Issue</label>
                <input type="text" name="issue" value="{{$data->issue}}" class="form-control"
            ...
            <div class="col-sm-12 pt-1">
                <a href="{{route('backend.journal.archive.index',$data->journal_id)}}" class="btn btn-success">
