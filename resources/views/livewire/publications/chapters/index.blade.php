            ...
            <thead>
                <th colspan="10">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <a class="btn btn-info" href="{{route('backend.publication.chapters.add',$publication_id)}}">
            ...
            <tbody>
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>{{$item->author}}</td>
                        <td>
                            <a href="{{route('backend.publication.chapters.edit',$item->id)}}" class="btn btn-info btn-sm">
