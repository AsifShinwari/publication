    ...
    <div class="container">
        <div class="row mt-2">
            <div class="col-12 alert-secondary">
                <h5 class="text-center">Add New Chapter
                    <!-- loading Status -->
                    <div wire:loading>
        ...
        <div class="row">
            ...
            <div class="col-12 pt-2">
                ...
                <textarea type="text" name="abstract" class="form-control"
            ...
            <div class="col-sm-12 pt-1">
                <a href="{{route('backend.publication.chapters.index',$publication_id)}}" class="btn btn-success">
