...
@section('contents') 
    <div class="container-fluid mt-2">
        <div class="row">
            ...
            @endif
            <div class="col-sm-8">
                <form action="{{route('backend.enter.dev.update')}}" method="post" id="main_form">
                    @csrf
                    <input type="hidden" name="enter_dev_id" form="main_form" value="{{$data->id}}">
                    <textarea name="description" id="description" form="main_form" rows="20">{!!$data->contents!!}</textarea>
                </form>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('backend.enter.dev.image_store')}}" method="post" enctype="multipart/form-data" id="image_form">
             <input name="description" type="hidden" id="image_desc" form="image_form">
            
            @csrf
            <input type="hidden" name="enter_dev_id" value="{{$data->id}}">
