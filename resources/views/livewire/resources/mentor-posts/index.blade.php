                ...
                <th colspan="8">
                    <div class="row">
                        ...
                        <div class="col-5 col-sm-2">
                            <a class="btn btn-info" href="{{route('backend.mentor.posts.add')}}">
                                <i class="fa fa-plus"></i> Add Mentor Post
            ...
            <tbody>
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('backend.mentor.posts.edit',$item->id)}}" class="btn btn-info btn-sm">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header p-1">
          <h4 class="modal-title">
              Are You Sure To Delete This Mentor Post?
          </h4>
